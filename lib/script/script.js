...
Script.LOCKTIME_THRESHOLD = 500000000;

Script.prototype.isTimeLockPublicKeyHashOut = function() {
  return !!(this.chunks.length === 8 &&
    this.chunks[1].opcodenum === Opcode.OP_CHECKLOCKTIMEVERIFY &&
    this.chunks[2].opcodenum === Opcode.OP_DROP &&
...
Script.types.CHECKLOCKTIMEVERIFY = 'TimeLock pay to public key hash'

Script.OP_RETURN_STANDARD_SIZE = 123;
...
Script.outputIdentifiers.CHECKLOCKTIMEVERIFY = Script.prototype.isTimeLockPublicKeyHashOut;
...
Script.prototype.addNumber = function(_number) {
...
Script.buildTimeLockPublicKeyHashOut = function(to, threshold) {
  $.checkArgument(to instanceof PublicKey || to instanceof Address || _.isString(to));
  $.checkArgument(_.isNumber(threshold));
  if (to instanceof PublicKey) {
    to = to.toAddress();
