...
/**
 * Add TimeLock to the transaction
 * @param {number} threshold:  funds can not spend until this threshold block height.
 * @param {number} amount in satoshis
 */
Transaction.prototype.addTimeLock = function(to, amount, threshold){
  this.addOutput(new Output({
    script: Script.buildTimeLockPublicKeyHashOut(to, threshold),
    satoshis: amount
  }));
  return this;
}
